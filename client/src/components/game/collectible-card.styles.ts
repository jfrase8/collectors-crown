...
export const card = tv({
  slots: {
    ...
    seal: "mx-auto my-2 flex size-24 shrink-0 items-center justify-center rounded-full border-4 border-double",
    /** Card artwork, occupying the same footprint as the seal placeholder. */
    art: "mx-auto my-2 size-24 shrink-0 object-contain select-none",
